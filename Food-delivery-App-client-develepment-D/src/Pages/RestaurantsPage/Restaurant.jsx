...
import { SpecialData } from "../../Assets/Data";
...
const Restaurant = () => {
    ...
    return (
        <div className="Restaurant__Page p-2 lg:w-4/5 lg:mx-auto">
            <div className="grid grid-cols-[max-content,1fr,max-content] gap-2 p-2 md:p-4 items-center">
                ...
                <div className="text-center text-lg flex items-center gap-1 place-content-center">Special Deals
            ...
            <motion.div variants={topSideVariants} initial='initial' animate='animate'
                ...
                <div className="grid p-2 gap-2">
                    <h1 className="text-xl font-bold text-center pb-2 text-green-800">Central Restaurant</h1>
                    <div className='block lg:grid lg:gap-10 lg:grid-cols-2 lg:items-center'>
                        <Swiper
                            ...
                            className="swiper__container pt-3 pb-6"
                        >
                            {
                                SpecialData.map((item, i) => (
                                    <SwiperSlide key={i}>
                                        ...
                                        <div className="grid gap-1 items-center justify-center text-center py-3 md:py-5">
                                            <h1 className="text-xl md:text-2xl font-medium">{item.name}</h1>
                                            <div className="text-sm md:text-base font-medium">${3.99 - (i * 0.1)}</div>
                                            <div className="flex gap-1 place-items-center justify-center text-xs text-slate-600">
                                                ...
                                                <span className="text-[10px] text-slate-500">({item.review} review)</span>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                ))
                            ...
                            <div className="p-5 md:p-7 border shadow-md rounded-lg">
                                ...
                                <div className="grid gap-1 grid-cols-[max-content,1fr] pt-3">
                                    ...
                                    <div className="text-xs font-semibold grid gap-4">
                                        <h2 className="flex gap-2">Outlet<span className="font-normal text-slate-700">Lima</span></h2>
                                        <h2>30-35 mins</h2>
                                    </div>
                                </div>
            ...
            <motion.footer variants={topAnimShakeVariants} initial='initial' animate='animate'
                className="fixed z-10 w-full left-0 -bottom-[4.7rem] p-4 md:p-6 pb-24 md:pb-24 rounded-t-2xl bg-green-900"
            >
                ...
                <div className='block lg:grid lg:grid-cols-2 lg:items-center lg:gap-10'>
                    ...
                    <div className='block lg:flex lg:justify-end'>
                        <button className="mt-3 lg:mt-0 rounded-3xl lg:rounded-lg font-medium text-green-900 bg-green-200 py-2 px-5 w-full lg:w-2/3 transition-all hover:scale-95 lg:hover:scale-100 hover:bg-green-100">Pay $4.99</button>
                    </div>
                </div>
            </motion.footer>
        </div>
