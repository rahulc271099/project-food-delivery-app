...
import { signout } from "../../Redux/Authentication/Action";
          ...
          <div className="p-3">
            ...
            <div className="pt-2">
              <ul className="grid gap-2 items-center">
                <li className="flex items-center justify-between py-2 px-3 text-base">
                  My Profile
                  <BsChevronRight />
                </li>
                <li className="flex items-center justify-between py-2 px-3 text-base">
            ...
            <div className="py-8">
              <button
                ...
                className="p-2 w-full bg-green-800 text-white font-semibold rounded-3xl transition-all hover:bg-green-700"
              >
                Sign Out
              </button>
            </div>
